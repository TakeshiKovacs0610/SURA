...
import os
import json
from dataloader import get_dataloader  # Old dataloader not used now
...
def main():
    ...
    # Define DEBUG flag
    DEBUG = True  # Set to False for full dataset training
    ...
    for config in configs:
        ...
        if DEBUG:
            ...
            num_epochs = 4  # Reduce number of epochs for debugging
