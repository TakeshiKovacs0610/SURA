...
# Converts the data into an iteratable data creating batches of it and giving you the option to enable shuffle after every epoch.
# num_workers -> number of subprocess to use for dataloading. More workers can speed up process.
...
for epoch in range(10):
    ...
    for i, data in enumerate(trainloader,0):
        ...
        loss.backward() # calculate the gradient loss with respect to the model parameters using back prop. 
